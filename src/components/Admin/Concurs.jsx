...
const Concurs = () => {
    ...
    //     try {
    //         await contestFilter(publicData);
            ...
            <div class="navbar"> 
                    <form class="search-counter" role="search"> 
                        <div class="search-counter-container" style={{justifyContent: "space-between"}}> 
                            <div class="search-counter-button"> 
                              <Link to={"/concurs"}> <button style={{color: "blue"}} >Черновики</button></Link>  
                ...
                <div className="container">
                    <Form>
                        ...
                        <Form.Group className="mb-3" controlId="contestDescription">
                            <Form.Control
                                as="textarea"
                                rows={3}
                        ...
                        <tr key={contest.codeid}>
                            ...
                            <td>
                                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                                    ...
                                    <Button variant="primary" onClick={() => handlePublish(contest.codeid)}>Опубликовать</Button>
                                </div>
                            </td>
                        </tr>
                    ))}
