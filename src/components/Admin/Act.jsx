...
const componentStyles = {
    ...
    return (
        <div class="oll_sistem">
                ...
                <div className="sidebar" style={{ borderRight: '1px solid #ddd', paddingRight: '15px', display: 'flex', flexDirection: 'column', width: "15vw" }}>
                    ...
                    <Nav className="flex-column">
                        ...
                        <NavItem style={{ display: "flex", alignItems: "center" }}>
                            ...
                            <NavLink href="/act">Добавить акт</NavLink>
                        </NavItem>
                    </Nav>
            ...
            <div>
                <p style={componentStyles.paragraph}>Добавление нормативного правового акта.</p>
            </div>
            <div style={componentStyles.inputContainer}>
                <input type="text" style={componentStyles.input} placeholder='Полное наименование, дата' />
            </div>
            <div>
                <input type="file" style={componentStyles.input} placeholder='Прикрепить файл' />
            </div>
        </div>
            </div>
        </div>
