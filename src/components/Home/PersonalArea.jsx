...
const PersonalArea = () => {
    ...
    useEffect(() => {
        if (userInfos && userInfos.length > 0) {
            const userOrders = userInfos.map(e => e.orders).flat();
    ...
    console.log(orders);
    return (
        <div className="personal-area-container" style={{ marginTop: '0.2vw', marginLeft: '1vw' }}>
                            ...
                            <Col md={3} >
                                <div>
                                    ...
                                    <div>
                                        ...
                                        </svg> <div style={{ display: "flex", alignItems: "center", gap: '0.3vw' }}><h6 style={{ margin: 0 }}> Электронная почта:</h6><span>{userInfo.email}</span></div></div>
                                    ...
                                    <div>
                                        ...
                                        </svg> <div style={{ display: "flex", alignItems: "center", gap: '0.3vw' }}><h6 style={{ margin: 0 }}>ИНН:</h6><span>{userInfo.inn}</span></div> </div>
                                    ...
                                    <div>
                                        <div className='personal-area-data'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0D6EFD" class="bi bi-building" viewBox="0 0 16 16">
                                            ...
                                            <div style={{ display: "flex", alignItems: "center", gap: '0.3vw' }}><h6 style={{ margin: 0 }}>Организация:</h6><span>{userInfo.name_organization}</span></div></div>
                                    ...
                                    <div>
                                        <div className='personal-area-data'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0D6EFD" class="bi bi-type-strikethrough" viewBox="0 0 16 16">
                                            ...
                                            <h6 style={{ margin: 0 }}>Тип организации:</h6></div>
                                    ...
                                    <div>
                                        <div className='personal-area-data'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0D6EFD" class="bi bi-person-bounding-box" viewBox="0 0 16 16">
                                            ...
                                            <div style={{ display: "flex", alignItems: "center", gap: '0.3vw' }}><h6 style={{ margin: 0 }}>Должность:</h6><span>{userInfo.position}</span></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div className='personal-area-data'> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0D6EFD" class="bi bi-house-door-fill" viewBox="0 0 16 16">
                                        ...
                                        <div style={{ display: "flex", alignItems: "center", gap: '0.3vw' }}><h6 style={{ margin: 0 }}>Адрес:</h6><span>{userInfo.address}</span></div>
                                    </div>
                                </div>
                                <div>
                                    <div className='personal-area-data'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0D6EFD" class="bi bi-bank2" viewBox="0 0 16 16">
                                        ...
                                        <div style={{ display: "flex", alignItems: "center", gap: '0.3vw' }}><h6 style={{ margin: 0 }}>Название банка:</h6><span>{userInfo.banc_name}</span></div>
                                    </div>
                                </div>
                                <div>
                                    <div className='personal-area-data'> <svg
                                        xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0D6EFD" class="bi bi-cash-coin" viewBox="0 0 16 16">
                                        ...
                                        <div style={{ display: "flex", alignItems: "center", gap: '0.3vw' }}><h6 style={{ margin: 0 }}>БИК:</h6><span>{userInfo.bik}</span></div>
                                    </div>
                                ...
                                <div>
                                    <div className='personal-area-data'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0D6EFD" class="bi bi-house" viewBox="0 0 16 16">
                                        ...
                                        <div style={{ display: "flex", alignItems: "center", gap: '0.3vw' }}><h6 style={{ margin: 0 }}>Юридический адрес:</h6><span>{userInfo.ur_address}</span></div>
                                    </div>
                                </div>
                                                    ...
                                                    <tbody>
                                                        {orders && orders.length > 0 ? (
                                                            orders.map((order, orderIndex) => (
                                                                <tr key={`${order.codeid}_${orderIndex}`}>
                                                                    <td>{orderIndex + 1}</td>
                                                                    <td>{order.contest_name}</td>
                                                                    <td>{order.contest_description}</td>
                                                                    <td>{order.format_purchase}</td>
                                                                    <td>{order.method_purchase}</td>
                                                                    <td>{order.type_purchase}</td>
                                                                    <td>{order.year}</td>
                                                                    <td>{order.planned_summ} сом</td>
                                                                    <td>
                                                                        {order.files && order.files.length > 0 ? (
                                                                            order.files.map((file, fileIndex) => (
                                                                                <div key={fileIndex} style={{ marginRight: '10px', display: 'flex', flexDirection: 'row', gap: 10 }}>
                                                                                    <div className='d-flex flex-row gap-2'>
                                                                                        <BsPaperclip style={{ marginRight: '5px', fontSize: '20px' }} />
                                                                                        <a target='_blank' rel='noopener noreferrer' download href={file.path}>{file.file_name}</a>
                                                                                    </div>
                                                                                </div>
                                                                            ))
                                                                        ) : (
