                            ...
                            {contestDetails?.map((contest, index) => (
                                <ListGroup variant="flush" key={index} className="mb-3">
                                    ...
                                    <div className='blockList'>
                                        ...
                                        <span className='title_descr'>{contest.contest_name}</span>
                                    </div>      
                                    <div className='blockList'>
                                        <span style={{ color: "gray" }} className="title_text">Номер:</span>
                                        <span
                                            className='title_descr'>{contest.codeid + contest.year + index + 1}</span>
                                    </div>
                                    <div className='blockList'>
                                        <span style={{ color: "gray" }} className="title_text">Способ закупки:</span>
                                        <span className='title_descr'>{contest.method_purchase}</span>
                                    </div>
                                    <div className='pushBlock'>
                                        {
                                            contest?.files?.length !== 0 &&
                                        <span  style={{ color: "gray" }} className="title_text">Наименование файла:</span>
                                        }
                                            ...
                                            <div className="table w-100" key={idx}>
                                                <div style={{ display: "flex", alignItems: "center" }}>
                                                    ...
                                                    <span style={{ display: 'flex', gap: 10, alignItems: "center" }}>
                                                        <a href={file.path} target='_blank'  download>{file.file_name}</a>
                            ...
                            {contestDetails.map((contest, index) => (
                                <ListGroup variant="flush" key={index} className="mb-3">
                                    <div className='blockList'>
                                        ...
                                        <span className='title_descr'>{contest.format_purchase}</span>
                                    </div>
                                    <div className='blockList'>
                                        <span style={{ color: "gray" }} className="title_text">Тип закупки:</span>
                                        <span  className='title_descr'>{contest.type_purchase}</span>
                                    </div>
                                    <div className='blockList'>
                                        <span style={{ color: "gray" }} className="title_text">Планируемая сумма:</span>
                                        <span  className='title_descr'>{contest.planned_summ} сом</span>
                                    </div>
                                    <div className='blockList'>
                                        <span style={{ color: "gray" }}
                                            className="title_text">Статус конкурса:</span><span
                                                ...
                                                className='title_descr'>{contest.status_contest}</span>

                                    </div>
                                    <div className='blockList'>
                                        <span  className="title_text">Окончание закупки:</span>
                                        <span  className='title_descr'> 
